...
function MovieCard({ movie }) {
  return (
    <article className="group relative min-w-[220px] overflow-hidden rounded-2xl border border-white/10 bg-slate-900/70 shadow-lg shadow-slate-950/40 transition duration-300 hover:-translate-y-2 hover:border-cyan-400/40">
